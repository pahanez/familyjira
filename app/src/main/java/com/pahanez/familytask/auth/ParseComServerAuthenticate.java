...
public class ParseComServerAuthenticate implements AuthenticateServer{
    ...
    public String userSignUp(String name, String email, String pass, String authType) throws Exception {
        ...
        httpPost.addHeader("X-Parse-Application-Id",AccountGeneral.APPLICATION_ID);
        ...
        try {
            ...
            Log.e("p37td8", "rest : " + response.getStatusLine().getStatusCode());
    ...
    public String userSignIn(String user, String pass, String authType) throws Exception {
        ...
        httpGet.addHeader("X-Parse-Application-Id", AccountGeneral.APPLICATION_ID);
        httpGet.addHeader("X-Parse-REST-API-Key", AccountGeneral.REST_API_ID);
